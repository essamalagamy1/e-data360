                ...
                <div class="grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div class="space-y-4 text-gray-700 text-lg leading-relaxed">
                            <p>
                                بدأنا رحلتنا في عام <span class="font-bold text-blue-600">2022</span> 
                                بهدف واضح: مساعدتك في تحليل بياناتك، وتصميم الداشبوردات وقواعد البيانات، وتصميم حلول رقمية مبتكرة لأعمالك.
                            </p>
                            <p>
                                نؤمن بأن البيانات هي الذهب الجديد، ولكن القيمة الحقيقية تكمن في كيفية تحليلها وعرضها بطريقة واضحة وقابلة للتنفيذ.
                            </p>
                            <p>
                                اليوم، نفخر بخدمة <span class="font-bold text-purple-600">+170 عميل</span> في مختلف القطاعات، ونواصل الابتكار لتقديم أفضل الحلول.
                            </p>
                        </div>
                    </div>
